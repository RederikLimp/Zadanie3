...
<li class="column">
    ...
    <ul>
        ...
        <card @deletethis="Delete" :column=1 :id="card.id" :title="card.title" :desc="card.desc" :deadline="card.deadline" :createtime="card.createtime">
        </card>
        </li>
        </ul>
    </li>
    <li class="column">
        ...
        <ul>
            ...
            <card @deletethis="Delete" :column=2>
            </card>
            </li>
        </ul>
    </li>
    <li class="column">
        ...
        <ul>
            ...
            <card @deletethis="Delete" :column=3>
            </card>
            </li>
        </ul> 
    </li>
    <li class="column">
        ...
        <ul>
            ...
            <card @deletethis="Delete" :column=4>
            </card>
            </li>
        </ul>
    </li>
